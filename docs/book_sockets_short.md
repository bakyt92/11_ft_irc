...
* почти все из них в случае ошибки возвращают -1 и устанавливают errno
...
* примеры:
  ...
  + Firefox/Apache
* Часто на машине работает один сервер, он обслуживает множество клиентов используя fork():
