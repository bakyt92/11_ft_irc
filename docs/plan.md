## нерешённые проблемы
* **пожалуйста давайте записывать сюда только то, что необходимо по сабжекту и работает на настоящем сревере, т.е ориентироваться на сабжекм + irssi, а не протокол (иначе мы не успеем.)**
