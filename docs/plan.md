...
* Как стать админом канала? По командам, указанным в сабжекте, можно только одним способом - создав канал. Т.о. у каждого канала ровно один оператор. Это нормально?  
* `valgrind` (в конце)
